...
@action(
        ...
        description="Performs a single right-button mouse click at the specified screen coordinates (or at the current cursor position if no coordinates are provided).",
        mode="GUI",
        input_schema={
                "x": {
                        "type": "integer",
...
def mouse_right_click(input_data: dict) -> dict:
